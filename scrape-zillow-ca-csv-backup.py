...
for i in pages:
    ...
    for bath in bath_raw:
        bath = int(bath.replace("ba", "").replace("--", "0").replace(" ", ""))
        baths.append(bath)
...
with open('D:/Data_Engineer/project/housing-webscraping-to-postgress-mongodb/output-csv/housing_ca.csv', 'w', newline='') as file:
